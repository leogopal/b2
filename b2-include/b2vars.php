...
/*
$is_lynx  = preg_match("/Lynx/",$HTTP_USER_AGENT);
$is_NS4   = ((preg_match("/Nav/",$HTTP_USER_AGENT) ) || (preg_match("/Mozilla\/4\./",$HTTP_USER_AGENT)));
...
$is_IE    = (($is_macIE) || ($is_winIE));
$is_opera = preg_match("/Opera/",$HTTP_USER_AGENT);
*/
